...
public class ComputerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int layout_marks=Integer.parseInt(layout);
        ...
        String coding_style=request.getParameter("coding style");
        int coding_marks=Integer.parseInt(coding_style);
        ...
        int total=layout_marks+presentation_marks+futureaspect_marks+coding_marks+report_from+learn_marks;
         ...
         try
        {
            ...
            PreparedStatement ps=con.prepareStatement("insert into cse_information values(?,?,?,?,?,?,?,?,?,?,?,?)");
            ps.setString(1, name);
            ps.setString(2, reg_no);
            ps.setString(3,project_name);
            ps.setString(4, org);
            ps.setString(5,layout);
            ps.setString(6, presentation);
            ps.setString(7,future_aspect);
            ps.setString(8, coding_style);
            ps.setString(9, report_format);
            ps.setString(10, learn_outcome);
