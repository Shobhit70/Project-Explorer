<%-- 
    Document   : cse
    Created on : Aug 13, 2017, 10:03:57 PM
    Author     : shobhit pc
--%>
  ...
  <div class="user">
    <header class="user__header">
        ...
        <div class="form__group">
          ...
          <div class="form__group">
              <input type="text" placeholder="Layout(10)" class="form__input" name="layout" required />
        </div>
          <div class="form__group">
          ...
          <div class="form__group">
              <input type="text" placeholder="Coding Style(20)" class="form__input" name="coding style" required />
        </div>
          <div class="form__group">
